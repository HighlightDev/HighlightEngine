...
namespace MassiveGame
{
    public class GridManager
    {
        ...
        public static void rectangleFillObjectToGrid(MotionEntities obj, TableGrid table) //polymorph function
        {
            // local variables  
        ...
        public static void polygonalFillObjectToGrid(MotionEntities obj, TableGrid table, double[,] vectorCoordinates,double YLevel)
        {
            double left, right, far, near;
            int counter = 0;
        ...
        public static void rectangleFillEmpty(MotionEntities obj, TableGrid table) //polymorph function
        {
            // local variables  
            double left, right, far, near;
            left = obj.Box.LBNCoordinates.X / table.GridStep;
