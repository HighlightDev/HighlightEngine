    ...
    public class PostProcessStageRenderer
    {
        ...
        public void ExecutePostProcessPass(ITexture frameColorTexture, ITexture frameDepthTexture, ref Point actualScreenRezolution)
        {
            ...
            if (bPostProcessEnabled)
            {
                ...
                // Light shafts
                if (GameWorld.GetWorldInstance().GetLevel().SunRenderer.GetData().IsInCameraView && lightShaftsPP != null)
                {
                ...
                // Lens flares
                if (GameWorld.GetWorldInstance().GetLevel().SunRenderer.GetData().IsInCameraView && lensFlaresPP != null)
                {
