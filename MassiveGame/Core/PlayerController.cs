...
namespace MassiveGame.Core
{
    ...
    public class PlayerController
    {
        ...
        private void Factory_BindActionToKey(Keys key, ActionTypeBinding actionBinding)
        {
            ...
            {
                case ActionTypeBinding.MoveForward: PlayerMoveForward = new Tuple<Action, Keys>(new Action(playerCamera.GetThirdPersonTarget().MoveActor), key); keyboard.AllocateKey(key); break;
