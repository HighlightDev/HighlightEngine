...
namespace MassiveGame
{
    public class LiteCamera
    {
        ...
        public Vector3 Up { set; get; } = new Vector3(0, 1, 0);

        public LiteCamera(Vector3 CamDir, float distanceToTarget)
        {
        ...
        public void SetThirdPersonTarget(MovableEntity target)
        {
            Target = target;
        }
        ...
        private void RotateDirection(Int32 deltaX, Int32 deltaY)
        {
            ...
            Vector3 WorldSpaceCameraDirection = VectorMath.multMatrix(AccumulatedRotation, LocalSpaceCamDir).Normalized();

            Vector3 rightVector = Vector3.Cross(WorldSpaceCameraDirection, new Vector3(0, 1, 0)).Normalized();
        ...
        public Matrix4 getViewMatrix()
        {
            ...
            //Vector3 target = Target.GetCharacterCollisionBound().GetOrigin();
        ...
        {
            return VectorMath.multMatrix(AccumulatedRotation, LocalSpaceCamDir);
        }
        ...
        //    if (Target == null)
        //        return Vector3.Zero;
        //    return Target.GetCharacterCollisionBound().GetOrigin();
        //}
